...
* `display_content.py`: create an overview of [StatProofBook content](https://github.com/StatProofBook/StatProofBookTools/blob/master/display_content/Content.png) and its [development over time](https://github.com/StatProofBook/StatProofBookTools/blob/master/display_content/Development.png).
