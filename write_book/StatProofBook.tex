...
\textbf{Definition:} Moment-generating function

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Probability theory $\vartriangleright$ Probability distributions $\vartriangleright$ Moment-generating function
...
\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Probability theory $\vartriangleright$ Bayesian inference $\vartriangleright$ Bayes' theorem

\vspace{1em}
\textbf{Theorem:} Let $A$ and $B$ be two arbitrary statements about random variables, such as statements about the presence or absence of an event or about the value of a scalar, vector or matrix. Then, the conditional probability that $A$ is true, given that $B$ is true, is equal to
...
\vspace{1em}
\textbf{Proof:} The conditional probability is defined as the ratio of joint probability, i.e. the probability of both statements being true, and marginal probability, i.e. the probability of only the second one being true:
...
\textbf{Proof:} Bayes' rule

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Probability theory $\vartriangleright$ Bayesian inference $\vartriangleright$ Bayes' theorem

\vspace{1em}
\textbf{Theorem:} Let $A_1$, $A_2$ and $B$ be arbitrary statements about random variables where $A_1$ and $A_2$ are mutually exclusive. Then, Bayes' rule states that the posterior odds are equal to the Bayes factor times the prior odds, i.e.
...
\vspace{1em}
\textbf{Proof:} Using Bayes' theorem, the conditional probabilities on the left are given by
...
\textbf{Proof:} Partition of the mean squared error into bias and variance

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Estimation theory $\vartriangleright$ Point estimates $\vartriangleright$ Partition of the mean squared error into bias and variance

\vspace{1em}
\textbf{Theorem:} The mean squared error can be partitioned into variance and squared bias
...
\vspace{1em}
\textbf{Proof:} The mean squared error (MSE) is defined as the expected value of the squared deviation of the estimated value $\hat{\theta}$ from the true value $\theta$ of a parameter, over all values $\hat{\theta}$:
...
\textbf{Proof:} Relation of mutual information to marginal and conditional entropy

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Information theory $\vartriangleright$ Discrete mutual information $\vartriangleright$ Relation to marginal and conditional entropy

\vspace{1em}
\textbf{Theorem:} Let $X$ and $Y$ be discrete random variables with the joint probability $p(x,y)$ for $x \in \mathcal{X}$ and $y \in \mathcal{Y}$. Then, the mutual information of $X$ and $Y$ can be expressed as
...
\vspace{1em}
\textbf{Proof:} The mutual information of $X$ and $Y$ is defined as
...
\textbf{Proof:} Relation of mutual information to marginal and joint entropy

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Information theory $\vartriangleright$ Discrete mutual information $\vartriangleright$ Relation to marginal and joint entropy
...
\textbf{Proof:} Relation of mutual information to joint and conditional entropy

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ General Theorems $\vartriangleright$ Information theory $\vartriangleright$ Discrete mutual information $\vartriangleright$ Relation to joint and conditional entropy
...
\vspace{1em}
\textbf{Proof:} The existence of the joint probability function ensures that the mutual information is defined:
...
\textbf{Proof:} Mean of the Bernoulli distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate discrete distributions $\vartriangleright$ Bernoulli distribution $\vartriangleright$ Mean

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a Bernoulli distribution:
...
\vspace{1em}
\textbf{Proof:} The expected value is the probability-weighted average of all possible values:
...
\textbf{Proof:} Mean of the binomial distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate discrete distributions $\vartriangleright$ Binomial distribution $\vartriangleright$ Mean

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a binomial distribution:
...
\vspace{1em}
\textbf{Proof:} By definition, a binomial random variable is the sum of $n$ independent and identical Bernoulli trials with success probability $p$. Therefore, the expected value is
...
\textbf{Proof:} Mean of the categorical distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate discrete distributions $\vartriangleright$ Categorical distribution $\vartriangleright$ Mean

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a categorical distribution:
...
\textbf{Proof:} Mean of the multinomial distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate discrete distributions $\vartriangleright$ Multinomial distribution $\vartriangleright$ Mean

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a multinomial distribution:
...
\vspace{1em}
\textbf{Proof:} By definition, a multinomial random variable is the sum of $n$ independent and identical categorical trials with category probabilities $p_1, \ldots, p_k$. Therefore, the expected value is
...
\textbf{Definition:} Continuous uniform distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Continuous uniform distribution $\vartriangleright$ Definition

\vspace{1em}
\textbf{Definition:} Let $X$ be a continuous random variable. Then, $X$ is said to be uniformly distributed with minimum $a$ and maximum $b$
...
\textbf{Proof:} Probability density function of the continuous uniform distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Continuous uniform distribution $\vartriangleright$ Probability density function

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a continuous uniform distribution:
...
\textbf{Proof:} Cumulative distribution function of the continuous uniform distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Continuous uniform distribution $\vartriangleright$ Cumulative distribution function
...
\textbf{Proof:} Quantile function of the continuous uniform distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Continuous uniform distribution $\vartriangleright$ Quantile function
...
\textbf{Definition:} Normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Definition

\vspace{1em}
\textbf{Definition:} Let $X$ be a random variable. Then, $X$ is said to be normally distributed with mean $\mu$ and variance $\sigma^2$ (or, standard deviation $\sigma$)
...
\textbf{Proof:} Probability density function of the normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Probability density function

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random variable following a normal distribution:
...
\textbf{Proof:} Mean of the normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Mean
...
\vspace{1em}
\textbf{Proof:} The expected value is the probability-weighted average over all possible values:
...
\textbf{Proof:} Median of the normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Median
...
\vspace{1em}
\textbf{Proof:} The median is the value at which the cumulative distribution function is $1/2$:

\begin{equation} \label{eq:norm-med-mean}
...
\textbf{Proof:} Mode of the normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Mode
...
\vspace{1em}
\textbf{Proof:} The mode is the value which maximizes the probability density function:
...
\textbf{Proof:} Variance of the normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Univariate continuous distributions $\vartriangleright$ Normal distribution $\vartriangleright$ Variance
...
\vspace{1em}
\textbf{Proof:} The variance is the probability-weighted average of the squared deviation from the mean:
...
\textbf{Definition:} Multivariate normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Multivariate normal distribution $\vartriangleright$ Definition

\vspace{1em}
\textbf{Definition:} Let $X$ be an $n \times 1$ random vector. Then, $X$ is said to be multivariate normally distributed with mean $\mu$ and covariance $\Sigma$
...
\textbf{Proof:} Probability density function of the multivariate normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Multivariate normal distribution $\vartriangleright$ Probability density function

\vspace{1em}
\textbf{Theorem:} Let $X$ be a random vector following a multivariate normal distribution:

\begin{equation} \label{eq:mvn-pdf-norm}
X \sim \mathcal{N}(\mu, \Sigma) \; .
\end{equation}
...
\textbf{Proof:} Linear transformation theorem for the multivariate normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Multivariate normal distribution $\vartriangleright$ Linear transformation theorem
...
\textbf{Proof:} Marginal distributions of the multivariate normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Multivariate normal distribution $\vartriangleright$ Marginal distributions
...
\textbf{Definition:} Normal-gamma distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Normal-gamma distribution $\vartriangleright$ Definition
...
\textbf{Proof:} Marginal distributions of the normal-gamma distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Normal-gamma distribution $\vartriangleright$ Marginal distributions
...
\vspace{1em}
\textbf{Proof:} The probability density function of the normal-gamma distribution ($\rightarrow$ Proof "ng-pdf") is given by
...
\textbf{Proof:} Kullback-Leibler divergence for the normal-gamma distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Multivariate continuous distributions $\vartriangleright$ Normal-gamma distribution $\vartriangleright$ Kullback-Leibler divergence

\vspace{1em}
\textbf{Theorem:} Let $x \in \mathbb{R}^k$ be a random vector and $y > 0$ be a random variable. Assume two normal-gamma distributions $P$ and $Q$ specifying the joint distribution of $x$ and $y$ as
...
\vspace{1em}
\textbf{Proof:} The probabibility density function of the normal-gamma (NG) distribution is
...
\textbf{Definition:} Matrix-normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Matrix-variate continuous distributions $\vartriangleright$ Matrix-normal distribution $\vartriangleright$ Definition
...
\textbf{Proof:} Equivalence of matrix-normal distribution and multivariate normal distribution

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Probability Distributions $\vartriangleright$ Matrix-variate continuous distributions $\vartriangleright$ Matrix-normal distribution $\vartriangleright$ Equivalence to multivariate normal distribution

\vspace{1em}
\textbf{Theorem:} The matrix $X$ is matrix-normally distributed
...
\vspace{1em}
\textbf{Proof:} The probability density function of the matrix-normal distribution with $n \times p$ mean $M$, $n \times n$ covariance across rows $U$ and $p \times p$ covariance across columns $V$ is
...
\textbf{Proof:} Ordinary least squares for multiple linear regression

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Normal data $\vartriangleright$ Multiple linear regression $\vartriangleright$ Ordinary least squares

\vspace{1em}
\textbf{Theorem:} Given a linear regression model with independent observations
...
\vspace{1em}
\textbf{Proof:} The residual sum of squares is defined as
...
\textbf{Proof:} Conjugate prior distribution for Bayesian linear regression

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Normal data $\vartriangleright$ Bayesian linear regression $\vartriangleright$ Conjugate prior distribution
...
\vspace{1em}
\textbf{Proof:} By definition, a conjugate prior is a prior distribution that, when combined with the likelihood function, leads to a posterior distribution that belongs to the same family of probability distributions. This is fulfilled when the prior density and the likelihood function are proportional to the model parameters in the same way, i.e. the model parameters appear in the same functional form in both.

Equation \eqref{eq:blr-prior-GLM} implies the following likelihood function
...
\textbf{Proof:} Posterior distribution for Bayesian linear regression

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Normal data $\vartriangleright$ Bayesian linear regression $\vartriangleright$ Posterior distribution
...
\vspace{1em}
\textbf{Proof:} According to Bayes' theorem, the posterior distribution is given by
...
Equation \eqref{eq:blr-post-GLM} implies the following likelihood function
...
\vspace{1em}
Combining the likelihood function \eqref{eq:blr-post-GLM-LF-Bayes} with the prior distribution \eqref{eq:blr-post-GLM-NG-prior}, the joint likelihood of the model is given by
...
Together, \eqref{eq:blr-post-GLM-NG-post-beta} and \eqref{eq:blr-post-GLM-NG-post-tau} constitute the joint posterior distribution of $\beta$ and $\tau$.
...
\textbf{Proof:} Log model evidence for Bayesian linear regression

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Normal data $\vartriangleright$ Bayesian linear regression $\vartriangleright$ Log model evidence
...
\vspace{1em}
\textbf{Proof:} According to the law of marginal probability, the model evidence for this model is:
...
Equation \eqref{eq:blr-lme-GLM} implies the following likelihood function
...
\textbf{Proof:} Maximum likelihood estimation for the general linear model

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Normal data $\vartriangleright$ General linear model $\vartriangleright$ Maximum likelihood estimation

\vspace{1em}
\textbf{Theorem:} Given a general linear model with matrix-normally distributed errors
...
\textbf{Proof:} Maximum likelihood estimation for Poisson-distributed data

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Poisson data $\vartriangleright$ Poisson-distributed data $\vartriangleright$ Maximum likelihood estimation

\vspace{1em}
\textbf{Theorem:} Let $y = \left\lbrace y_1, \ldots, y_n \right\rbrace$ be a set of observed counts independent and identically distributed according to a Poisson distribution with rate $\lambda$:
...
\vspace{1em}
\textbf{Proof:} The likelihood function for each observation is given by the probability mass function of the Poisson distribution
...
\textbf{Proof:} Conjugate prior distribution for the Poisson distribution with exposure values

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Poisson data $\vartriangleright$ Poisson distribution with exposure values $\vartriangleright$ Conjugate prior distribution
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the Poisson distribution ($\rightarrow$ Proof "poiss-pmf"), the likelihood function for each observation implied by \eqref{eq:poissexp-prior-Poiss-exp} is given by
...
\textbf{Proof:} Posterior distribution for the Poisson distribution with exposure values

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Poisson data $\vartriangleright$ Poisson distribution with exposure values $\vartriangleright$ Posterior distribution
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the Poisson distribution ($\rightarrow$ Proof "poiss-pmf"), the likelihood function for each observation implied by \eqref{eq:poissexp-post-Poiss-exp} is given by
...
\textbf{Proof:} Log model evidence for the Poisson distribution with exposure values

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Poisson data $\vartriangleright$ Poisson distribution with exposure values $\vartriangleright$ Log model evidence
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the Poisson distribution ($\rightarrow$ Proof "poiss-pmf"), the likelihood function for each observation implied by \eqref{eq:poissexp-lme-Poiss-exp} is given by
...
\textbf{Proof:} Method of moments for beta-distributed data

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Probability data $\vartriangleright$ Beta-distributed data $\vartriangleright$ Method of moments

\vspace{1em}
\textbf{Theorem:} Let $y = \left\lbrace y_1, \ldots, y_n \right\rbrace$ be a set of observed counts independent and identically distributed according to a beta distribution with shapes $\alpha$ and $\beta$:
...
\vspace{1em}
\textbf{Proof:} Mean and variance of the beta distribution in terms of the parameters $\alpha$ and $\beta$ are given by
...
\textbf{Proof:} Conjugate prior distribution for binomial observations

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Categorical data $\vartriangleright$ Binomial observations $\vartriangleright$ Conjugate prior distribution

\vspace{1em}
\textbf{Theorem:} Let $y$ be the number of successes resulting from $n$ independent trials with unknown success probability $p$, such that $y$ follows a binomial distribution:
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the binomial distribution ($\rightarrow$ Proof "bin-pmf"), the likelihood function implied by \eqref{eq:bin-prior-Bin} is given by
...
\textbf{Proof:} Posterior distribution for binomial observations

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Categorical data $\vartriangleright$ Binomial observations $\vartriangleright$ Posterior distribution
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the binomial distribution ($\rightarrow$ Proof "bin-pmf"), the likelihood function implied by \eqref{eq:bin-post-Bin} is given by

\begin{equation} \label{eq:bin-post-Bin-LF}
\mathrm{p}(y|p) = {n \choose y} \, p^y \, (1-p)^{n-y} \; .
\end{equation}

Combining the likelihood function \eqref{eq:bin-post-Bin-LF} with the prior distribution \eqref{eq:bin-post-Bin-prior}, the joint likelihood of the model is given by
...
\textbf{Proof:} Log model evidence for binomial observations

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Statistical Models $\vartriangleright$ Categorical data $\vartriangleright$ Binomial observations $\vartriangleright$ Log model evidence
...
\vspace{1em}
\textbf{Proof:} With the probability mass function of the binomial distribution ($\rightarrow$ Proof "bin-pmf"), the likelihood function implied by \eqref{eq:bin-lme-Bin} is given by

\begin{equation} \label{eq:bin-lme-Bin-LF}
\mathrm{p}(y|p) = {n \choose y} \, p^y \, (1-p)^{n-y} \; .
\end{equation}

Combining the likelihood function \eqref{eq:bin-lme-Bin-LF} with the prior distribution \eqref{eq:bin-lme-Bin-prior}, the joint likelihood of the model is given by
...
\textbf{Proof:} Derivation of R² and adjusted R²

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Model Selection $\vartriangleright$ Goodness-of-fit measures $\vartriangleright$ R-squared $\vartriangleright$ Derivation of R² and adjusted R²

\vspace{1em}
\textbf{Theorem:} Given a linear regression model
...
\vspace{1em}
\textbf{Proof:} The coefficient of determination $R^2$ is defined as the proportion of the variance explained by the independent variables, relative to the total variance in the data.
...
\textbf{Proof:} Relationship between R² and maximum log-likelihood

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Model Selection $\vartriangleright$ Goodness-of-fit measures $\vartriangleright$ R-squared $\vartriangleright$ Relationship to maximum log-likelihood
...
\vspace{1em}
\textbf{Proof:} First, we express the maximum log-likelihood (MLL) of a linear regression model in terms of its residual sum of squares (RSS). The model in \eqref{eq:rsq-mll-MLR} implies the following log-likelihood function
...
For $m_1$, the residual sum of squares is given by \eqref{eq:rsq-mll-RSS}; and for $m_0$, the residual sum of squares is equal to the total sum of squares:
...
\textbf{Proof:} Derivation of the Bayesian information criterion

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Model Selection $\vartriangleright$ Classical information criteria $\vartriangleright$ Bayesian information criterion $\vartriangleright$ Derivation

\vspace{1em}
\textbf{Theorem:} Let $p(y \mid \theta, m)$ be the likelihood function ($\rightarrow$ Definition "lf") of a generative model $m \in \mathcal{M}$ with model parameters $\theta \in \Theta$ describing measured data $y \in \mathbb{R}^n$. Let $p(\theta \mid m)$ be a prior distribution ($\rightarrow$ Definition "prior") on the model parameters. Assume that likelihood function and prior density are twice differentiable.

Then, as the number of data points goes to infinity, an approximation to the log-marginal likelihood ($\rightarrow$ Definition "ml") $\log p(y \mid m)$, up to constant terms not depending on the model, is given by the Bayesian information criterion (BIC) as
...
\vspace{1em}
\textbf{Proof:} Let $\mathrm{LL}(\theta)$ be the log-likelihood function
...
\textbf{Proof:} Derivation of the log model evidence

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Model Selection $\vartriangleright$ Bayesian model selection $\vartriangleright$ Log model evidence $\vartriangleright$ Derivation

\vspace{1em}
\textbf{Theorem:} Let $p(y \mid \theta,m)$ be a likelihood function of a generative model $m$ for making inferences on model parameters $\theta$ given measured data $y$. Moreover, let $p(\theta \mid m)$ be a prior distribution on model parameters $\theta$. Then, the log model evidence (LME), also called marginal log-likelihood,
...
\textbf{Proof:} Partition of the log model evidence into accuracy and complexity

\vspace{1em}
\textbf{Index:} The Book of Statistical Proofs $\vartriangleright$ Model Selection $\vartriangleright$ Bayesian model selection $\vartriangleright$ Log model evidence $\vartriangleright$ Partition into accuracy and complexity

\vspace{1em}
\textbf{Theorem:} The log model evidence can be partitioned into accuracy and complexity
...
\vspace{1em}
\textbf{Proof:} We consider Bayesian inference on data $y$ using model $m$ with parameters $\theta$. Then, Bayes' theorem makes a statement about the posterior distribution, i.e. the probability of parameters, given the data and the model:
